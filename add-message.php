...
$sql="INSERT INTO  tblmessage(Person,Sub,Message) VALUES(:person,:sub,:message)";
...
header('Location: /srms/add-message.php');
exit ;
}
else 
{
...
<label for="default" class="col-sm-2 control-label"> Message From </label>
<div class="col-sm-10">
<select name='person'>
<option value='Director'> From Director </option>
...
<div class="col-sm-10">
<input type="text" name="sub" class="form-control" id="sub" required="required" autocomplete="off">
</div>
</div>

<div class="form-group">
<label for="default" class="col-sm-2 control-label"> Message </label>
<div class="col-sm-10">
