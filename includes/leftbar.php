<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                ...
                                <h6 class="title">ksrgeeks.wordpress.com</h6>
                                <small class="info">Online Tutor</small>
                            </div>
                            <!-- /.user-info -->
...
<li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="find-result.php"><i class="fa fa-bars"></i> <span>Find Result</span></a></li>
										...
										<li class="has-children">
                                        <a href="#"><i class="fa fa-users"></i> <span>Certificates</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="#"><i class="fa fa-bars"></i> <span>Generate CC</span></a></li>
                                            <li><a href="#"><i class="fa fa-bars"></i> <span>Generate TC</span></a></li>
                                            <li><a href="#"><i class="fa fa fa-server"></i> <span>Manage Certificates</span></a></li>
                                           
                                        </ul>
                                    </li>	
										<li class="has-children">
                                        <a href="#"><i class="fa fa-users"></i> <span>Gallery</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="#"><i class="fa fa-bars"></i> <span>Add Images</span></a></li>
                                            <li><a href="#"><i class="fa fa fa-server"></i> <span>Manage Gallery</span></a></li>
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-users"></i> <span>Message from School</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="add-message.php"><i class="fa fa-bars"></i> <span>Add Message</span></a></li>
                                            <li><a href="manage-messages.php"><i class="fa fa fa-server"></i> <span>Manage Message</span></a></li>  
