...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            ...
                                                            <td><?php echo htmlentities($result->RegisterDate);?></td>
                                                           
<td>
<a href="edit-teacher.php?stid=<?php echo htmlentities($result->TeacherId);?>"><i class="fa fa-edit" title="Edit Record"></i> </a> 
