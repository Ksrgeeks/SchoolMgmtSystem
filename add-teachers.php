...
$sql="INSERT INTO  tblteachers(TeacherName,Mobile,TeacherEmail,Gender,Dob,Subject,Designation,Experience,Address) VALUES(:teachername,:mobile,:teacheremail,:gender,:dob,:subject,:designation,:experience,:address)";
...
<html lang="en">
    <head>
        ...
        <title>SMS Admin| Teachers< </title>
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->SubjectName); ?>&nbsp; Section-<?php echo htmlentities($result->SubjectCode); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
...
<div class="col-sm-10">
 <select name="designation" class="form-control" id="default" required="required">
<option value="0">Select Designation</option>
<option value="1">PRT</option>
<option value="2">TGT</option>
<option value="3">PGT</option>
</select>

</div>
</div>
<div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Experience(Years)</label>
                                                        <div class="col-sm-10">
