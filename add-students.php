...
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,FatherName,RollId,Mobile,StudentEmail,Gender,ClassId,session,DOB,Address,Status) VALUES(:studentname,:fathername,:rollid,:mobile,:studentemail,:gender,:classid,:session,:dob,:address,:status)";
