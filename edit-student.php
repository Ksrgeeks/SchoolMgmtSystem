...
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,FatherName=:father,RollId=:rollld,Mobile=:mobile ,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,Address=:address ,Status=:status where StudentId=:stid ";
$query = $dbh->prepare($sql);
$query->bindParam(':studentname',$studentname,PDO::PARAM_STR);
$query->bindParam(':father',$father,PDO::PARAM_STR);
$query->bindParam(':rollld',$rollld,PDO::PARAM_STR);
...
$sql = "SELECT tblstudents.StudentId,tblstudents.StudentName,tblstudents.FatherName,tblstudents.RollId,tblstudents.Mobile,tblstudents.StudentEmail,tblstudents.Gender,tblstudents.DOB,tblstudents.RegDate,tblstudents.Address,tblstudents.Status,tblclasses.ClassName,tblclasses.Section,tblstudents.Session,tblstudents.Address from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.StudentId=:stid";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-10">
<input type="text" name="father" class="form-control" id="father" value="<?php echo htmlentities($result->FatherName)?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="session" class="form-control" id="fullanme" value="<?php echo htmlentities($result->Session)?>" required="required" autocomplete="off">
</div>
</div>
